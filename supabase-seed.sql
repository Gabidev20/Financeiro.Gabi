...
insert into public.expenses (description, category, amount, is_paid, month, year) values
  ('Cartão de crédito',       'Cartão',      877.38, false, 9, 2026),
  ('Crédito de celular',      'Celular',      30.00, true,  9, 2026),
  ('Aluguel das casas',       'Moradia',     125.00, false, 9, 2026),
  ('Farmácia',                'Saúde',        27.00, false, 9, 2026),
  ('DAS - empresa (Pix)',     'Empresa',      87.05, false, 9, 2026),
  ('TV parcela (Pix)',        'Assinaturas',  60.00, true,  9, 2026),
  ('Lavagem de roupas (Pix)', 'Serviços',     80.00, false, 9, 2026),
  ('Gastos extras',           'Extras',      197.00, false, 9, 2026);
